    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirebaseDatabase.getInstance().getReference().child("MyUsers").orderByChild("profile").equalTo(edtName.getText().toString())
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists()){
                                    FancyToast.makeText(SignupActivity.this,"this profilename already exists try using another name",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show();
                                }else {
                                    signup();
                                }
                            }
